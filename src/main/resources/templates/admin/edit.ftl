    	 ...
    	 <div class="col-md-12">
            <form id="articleForm" role="form" novalidate="novalidate">
                ...
                <div class="form-group col-md-6" style="padding: 0 10px 0 0;">
                    <input id="bookTitle" type="text" class="form-control" placeholder="书籍名称" name="title" required="required" aria-required="true" value="${Book.bookTitle}"/>
                </div>


                <div class="form-group col-md-6" style="padding: 0 10px 0 0;">
                    <input id="bookAuthor" name="tags" id="tags" type="text" class="form-control" placeholder="书籍作者" value="${Book.bookAuthor}" />
                </div>

                <div class="form-group col-md-6" style="padding: 0 10px 0 0;">
                    <input id="bookDesc" name="tags" id="tags" type="text" class="form-control" placeholder="书籍描述" value="${Book.bookDesc}" />
                </div>
                <div class="form-group col-md-6" style="padding: 0 10px 0 0;">
                    <input id="bookImg" name="tags" id="tags" type="text" class="form-control" placeholder="书籍图片地址" value="${Book.bookImg}"/>
                </div>
                <div class="form-group col-md-6" style="padding: 0 10px 0 0;">
                    <input id="id" name="tags" id="tags" type="text" class="form-control" placeholder="id" value="${Book.id}" />
                </div>
            </form>
        </div>
...
$(function(){
	$('#submit').bind("click",function(){
		...
		$.ajax({
			url:comm.ServerUrl+'admin/book/update',
			type:'Post',
